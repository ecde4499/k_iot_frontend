...
// console.log(letVar3);
// ReferenceError: Cannot access 'lerVar3' before initialization
// >> 호이스팅이 되지만, 실질적인 선언 문장을 읽기 전 호출이 불가!

varVar3 = 40;
console.log(varVar3); 
// 호이스팅과 TDZ 접근 가능으로 내용값 출력 가능

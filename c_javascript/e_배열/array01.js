...
//          unshift() - 제일 첫 번째 요소부터 하나 이상의 요소를 추가 
//                      (+ 수정된 배열 길이를 반환)
...
console.log(fruitValues.join()); // 사과,바나나,망고 - 구분자를 전달 X 기본값 ','

...
// function defaultFunc(param=value1, param=value2) {
// }
...
greet1('이승아', 30) // 안녕하세요, 이승아님! 30세 입니다.
greet1(29) // 안녕하세요, 29님! undefined세 입니다.

function greet2(age, name='비회원 고객') {
  console.log(`안녕하세요, ${name}님! ${age}세 입니다.`);
}
greet2(30, '이승아') // 안녕하세요, 이승아님! 30세 입니다.
greet2(29) // 안녕하세요, 비회원 고객님! 29세 입니다.
...
console.log(findMin(31, 23, 45, 66, 43, 22)); // 22

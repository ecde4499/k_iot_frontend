...
// - HTML 이벤트 핸들러 속성은 on키워드와 이벤트 사이에 대문자 반환이 발생하지 X
bgButton.onclick = function() {
  ...
  bgButton.style.border = `3px solid black`
}

const textParagraph = document.querySelector("#keydown");

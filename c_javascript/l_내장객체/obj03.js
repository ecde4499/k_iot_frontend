...
let now = new Date();
console.log(now); // 2025-10-20T03:13:12.985Z (한국 UTC 9시간 빠름 : UTC+9)
...
console.log(now.toLocaleTimeString()); // 오후 12:20:51 > 오전/오후 HH:mm:SS

// cf) 월-일-년도 (MM-DD-YYYY): 미국, 캐나다 등

//! == 요일 데이터 문자열 변환 == //
const current = new Date();
console.log(current); // 2025-10-20T03:23:30.838Z

...
// cf) http://localhost:8080 - 보안이 없는 브라우져
//      >> http's'(security)
...
//! 1) 쿠키 생성 및 수정
// doucument.cookie = "쿠키이름=쿠키값; expires=날짜; path=경로; domain=도메인";
// - 쿠키이름, 쿠키값 (필수)
// - 나머지 (선택)
...
document.cookie = "userEamil=qwe123;" + expires + "; path=/";
...
// username=lsa; username=lsa; uerEmail=qwe123
// >> 문자열이기 때문에 직접 파싱
...
function getCookie(name) {
  ...
  // >> 이터러블(순서가 없는 자료형: 배열, 문자열, Map, Set 등)
  // >> 실제 요소 값을 순회
  // >> 사용 권장 대상: 배열, 문자열 등
...
//! 4) 쿠키 삭제
// : 만료 시간을 과거 시간으로 설정
document.cookie = "username=; expries=Thu, 01 , Jan 1970 00:00:00 GMT; path=/";

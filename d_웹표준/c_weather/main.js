...
const apiKey = "e6ba61ca8e93c48ef7e73dcf88862c8f"
const lang = "kr";
...
async function getWeatherData(city) {
  ...
  try {
    ...
    document.getElementById('weather-info').innerHTML = `<p>날씨 정보를 불러오는데 실패하였습니다. (${e.message})</p>`;
  }
}

...
console.log(generic<number>(123));
...
let resultFucn = genericFunc<boolean>([true, false, true]); // 배열의 길이: 3
console.log(resultFucn); // [ true, false, true ]
...
class GenericClass<T> {
  ...
  constructor(value: T, addFunc: (x: T, t: T) => T) {
    this.value = value;
    this.add = addFunc;
  }
}

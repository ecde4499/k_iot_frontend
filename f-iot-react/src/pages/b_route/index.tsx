import A_DashBoard from '@/routes/A_DashBoard'
import A_DashBoardSettings from '@/routes/A_DashBoardSettings'
import A_DashBoardStats from '@/routes/A_DashBoardStats'
...
// : HTML5 History API를 사용하여 브라우저 주소(URL)와 리엑트 UI 동기화
// - 앱 루트 최상단 main.tsx 또는 App.tsx에 반드시 명시!
//   하위 컴포넌트 들이 React Router DOM 사용 가능
...
//* - 주요 속성
//    path    : URL 경로 (문자열)
//    element : 해당 결로에 매칭될 때 렌더링할 컴포넌트
